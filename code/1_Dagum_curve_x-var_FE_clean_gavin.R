...
nls2_fit <- nls2(
  ES_pcap ~ dagum_model_1(GDP_PPP_pcap, density_psqkm, Gini_01, alpha_0, alpha_1, scal, shape1_0, shape1_1, shape2), data = data1,
  start = data.frame(
    ...
    shape1_1 = seq(0.1, 10, length.out = 10),      # avoid 0 and large values
