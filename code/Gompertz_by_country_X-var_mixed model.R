...
Gompertz_model <- deriv(
  ~ (alpha + beta1 * density_psqkm) * exp(-b * exp(-(gamma * Gini) * GDP_PPP_pcap)),
...
data_clean <- subset(data_input, complete.cases(GDP_PPP_pcap, density_psqkm, Year0, Gini, ES_pcap, country_name))
